function FeaturedSection() {
    const cakes = [
        ...
        { id: 3, name: 'Marraige', image: './src/assets/featured section/3.jpg' },
        ...
        { id: 7, name: 'Hallowen', image: './src/assets/featured section/7.jpg' },
        ...
        <section id="order" className="bg-[#bbbbb9] py-12">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                        {cakes.map((cake) => (
                            <div key={cake.id} className="bg-gray-100 p-4 rounded-lg shadow-md hover:shadow-lg transition-all">
